...
/***/ function(module, exports, __webpack_require__) {
	...
	var _resources = __webpack_require__(291);
	
	var _shapes = __webpack_require__(292);
	
	var shapes = _interopRequireWildcard(_shapes);
	
	var _resourcesDisplay = __webpack_require__(293);
	
	var ui = _interopRequireWildcard(_resourcesDisplay);
	
	var _resourcesButton = __webpack_require__(294);
	
	var button = _interopRequireWildcard(_resourcesButton);
...
/***/ function(module, exports) {
	...
	var debug_reset = exports.debug_reset = function debug_reset() {
		res.wood = 0;
		res.stone = 0;
		res.fish = 0;
...
/***/ function(module, exports) {
	...
	function drawGrid(context, x, y, space) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.buttonPosList = exports.buttonSrcList = exports.canvaSize = undefined;
	...
	function displayResources(context) {
	    context.font = "10px calibri";
	    shapes.drawText(context, 'wood : ', 10, 15);
	    shapes.drawText(context, _resources.res['wood'], 40, 15);
	}
	
	var canvaSize = exports.canvaSize = {
	    x: 1280,
	    y: 720
	};
	
	var buttonSrcList = exports.buttonSrcList = {
	    'wood': './images/wood.png'
	};
	
	var buttonPosList = exports.buttonPosList = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helper = __webpack_require__(295);
	
	var canvasHelper = _interopRequireWildcard(_helper);
	
	var _resourcesDisplay = __webpack_require__(293);
	
	var _woodProducer = __webpack_require__(296);
	
	var _woodProducer2 = _interopRequireDefault(_woodProducer);
	...
	var Button = function () {
	    function Button(size, imageSrc, displayZone) {
	...
	var WoodButton = function (_Button) {
	    _inherits(WoodButton, _Button);
	
	    function WoodButton() {
	        _classCallCheck(this, WoodButton);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(WoodButton).call(this, producerButtonSize, _resourcesDisplay.buttonSrcList['wood'], _resourcesDisplay.buttonPosList['wood']));
	    }
	
	    _createClass(WoodButton, [{
	        key: 'click',
	        value: function click(canvas) {
	            canvas.addEventListener("click", mouseClickListener, false);
	            function mouseClickListener(e) {
	                var mouseLoc = canvasHelper.windowToCanvas(canvas, e.clientX, e.clientY);
	                if (mouseLoc.x >= _resourcesDisplay.buttonPosList['wood'].x && mouseLoc.x <= _resourcesDisplay.canvaSize.x && mouseLoc.y >= producerButtonSize.y - producerButtonSize.y && mouseLoc.y <= producerButtonSize.y) {
	                    var producer = new _woodProducer2.default();
	                    producer.produce();
	                }
	            }
	        }
	...
	var wButton = exports.wButton = new WoodButton();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _producer = __webpack_require__(297);
	...
	var WoodProducer = function (_Producer) {
	    _inherits(WoodProducer, _Producer);
	
	    function WoodProducer() {
	        _classCallCheck(this, WoodProducer);
	
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(WoodProducer).call(this, _resources.production['wood'], 'wood'));
	    }
	
	    return WoodProducer;
	}(_producer2.default);

	exports.default = WoodProducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Producer = function () {
	    function Producer(quantity, type) {
	    ...
	    _createClass(Producer, [{
	        ...
	        value: function produce() {
	            _resources.res[this.type] += this.quantity;
